...
This is also the kind of build I'd want to be doing for a customer in an applied-AI role: identify a real friction (onboarding into existing knowledge is slow), use AI for the part it's good at (consolidating unstructured context), and ship the result inside a surface the user was already going to open.
